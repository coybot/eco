...
Requires: AWS_PROFILE=presidio (real Bedrock access), the presidio venv (real
...
Usage:
    AWS_PROFILE=presidio AWS_REGION=us-east-1 \
        /Users/jsaib/.presidio-venv/bin/python3 fw_count_eval.py
"""
