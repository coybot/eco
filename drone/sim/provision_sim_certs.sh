...
#
#   AWS_PROFILE=coybot bash provision_sim_certs.sh sim-quadcopter-001 [sim-rover-004 ...]
#
# Region is pinned: the `coybot` profile defaults to us-east-1 but the IoT stack
# lives in us-west-2.
set -euo pipefail
