...
> - Flat copy on hoopoe: BOTH /home/yusuf/ AND ~/coybot-training/eco/drone/training/.
>
> ---
...
You are continuing a project that built a learned mid-level "analog pilot" for Coybot
...
- Training package synced to `~/coybot-training/`; run as `cd ~/coybot-training && PYTHONPATH=. <py> -m eco.drone.training.<mod>`.
...
- Validate: `cd ~/coybot-training/eco/drone/training && PYTHONPATH=/home/yusuf/coybot-training <py> validate_v3.py --models-dir /home/yusuf/models --n 300`
- Render gauntlet2: stage model to `/home/yusuf/models`, copy the flat files to `/home/yusuf/`,
  `<py> record_comparison.py --models-dir /home/yusuf/models --onnx-name policy_v4_dr.onnx --out /tmp/coybot_course --env none`; pull `/tmp/coybot_course/chase_gauntlet2.mp4`.
...
- **Stale flat copies on `/home/yusuf/`**: if you change `SEQ_LEN` or the state contract, the
  ...
  to BOTH `~/coybot-training/eco/drone/training/` AND `/home/yusuf/`, or you get
