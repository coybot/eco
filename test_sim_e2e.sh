...
#   - AWS profile 'presidio' configured
...
AWS_PROFILE=presidio aws dynamodb put-item \
...
AWS_PROFILE=presidio aws lambda invoke \
...
AWS_PROFILE=presidio aws dynamodb query \
