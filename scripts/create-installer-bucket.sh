#!/usr/bin/env bash
# Create the coybot-drone-installer S3 bucket and copy the existing
...
# at coybot-drone-installer, which doesn't exist until this runs.
#
# Usage: ./create-installer-bucket.sh
set -euo pipefail

SRC_BUCKET="astral-drone-installer"
DST_BUCKET="coybot-drone-installer"
