...
def build_routes(handler_mod, rover_mod, drones_mod, conversations_mod, groups_mod) -> list:
    ...
    return [
        ...
        Route("POST", "/drones/{droneId}/conversations/{conversationId}/plan",
              conversations_mod.plan_handler),
        Route("POST", "/drones/{droneId}/conversations/{conversationId}/plan/select",
              conversations_mod.plan_select_handler),
