...
in CI or the e2e gate. Run manually:
    ...
    cd eco && AWS_PROFILE=coybot python3 rover/models/probe_mission_cognition.py
    cd eco && AWS_PROFILE=coybot python3 rover/models/probe_mission_cognition.py --with-photo
