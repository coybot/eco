...
def converse_handler(event, context):
    ...
    ClaudeDialogClient.swift in the sibling presidio-sdk repo (swift/Sources/PhroverCloud)
...
def act_handler(event, context):
    ...
    CloudBrain.swift / HybridBrain.swift in the sibling presidio-sdk repo
