"""
Unit tests for aws/src/backends/local.py's LocalDynamo/LocalIoTData/LocalS3
shims, exercised against the exact call patterns found in aws/src/{conversations,
...
Run: python3 -m pytest aws/src/backends/test_local.py -v
"""
import tempfile
