...
│     └── Creates WPA2/WPA3 hotspot: "Presidio-<model>-XXXX"     │
...
│                                                                 │
│  3. User joins "Presidio-<model>-XXXX" (WPA2/WPA3, see below)  │
...
- Hotspot name derived from model + MAC: `Presidio-{model}-{mac[-4:]}` (e.g., `Presidio-NVIDIAJetson-F1A2`)
- Hotspot is WPA2/WPA3; the passphrase is generated once and stored at `/var/lib/presidio/hotspot_password` (it doubles as the provisioning Bearer token)
...
2. Start a WiFi hotspot (`Presidio-<model>-XXXX`, WPA2/WPA3 — passphrase in `/var/lib/presidio/hotspot_password`)
