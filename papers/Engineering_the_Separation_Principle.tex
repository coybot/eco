...
then construct ZeroClaw, a 6.7-million-frame drone-perspective dataset
...
addresses. All code, data, the ZeroClaw dataset, and the complete
...
constructed ZeroClaw, a 6.7-million-frame dataset across 275 indoor
...
\textbf{2) ZeroClaw}, a 6.7-million-frame drone-perspective dataset
...
\\subsection{ZeroClaw Dataset}\label{a.-zeroclaw-dataset}

We constructed ZeroClaw by flying a simulated Holybro x500v2 drone
through 275 indoor 3D scenes in Habitat-Sim, collecting multi-modal
sensor data at dense waypoints.

\textbf{TABLE III:} ZeroClaw dataset statistics.
...
R17 GDINO R7 & GDINO-tiny & 40K ZeroClaw + 1.5K Isaac Sim & 45.4\% &
...
ZeroClaw's 6.7M frames across 275 environments represents substantial
...
\item
  ...
  not generalize. (4) ZeroClaw annotations use category-level labels,
...
first time. A 6.7-million-frame dataset (ZeroClaw) and four fine-tuning
...
ZeroClaw dataset, and the complete pipeline to enable others to start
