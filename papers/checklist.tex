...
\item {\bf Open access to data and code}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: The Yonder dataset is openly hosted at \url{https://huggingface.co/datasets/coybothf/yonder} (CC-BY-NC-4.0); a $\sim$500\,MB reviewer sample is at \url{https://huggingface.co/datasets/coybothf/yonder-sample}. All four fine-tuned checkpoints, closed-loop benchmark code, and complete trial logs are released alongside the dataset. The dataset card and Croissant metadata document loading, splits, and preprocessing.
