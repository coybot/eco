...
const DESC = "Presidio autonomous platforms: Quadcopter, Rover, Fixed-Wing, and Phrover. NDAA-compliant, GPS-denied capable, Jetson on-device AI or bring your own phone.";

export const metadata: Metadata = {
  title: "Products",
  description: DESC,
  ...socialMeta("/products", "Products | Presidio", DESC),
};
