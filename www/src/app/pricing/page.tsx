...
const DESC = "Transparent pricing for Presidio hardware and software. Quadcopter $9,000, Rover $4,000, Fixed-Wing $14,000, Phrover $1,000. Free SDK tier, Pro at $49/mo, Enterprise custom.";

export const metadata: Metadata = {
  title: "Pricing",
  description: DESC,
  ...socialMeta("/pricing", "Pricing | Presidio", DESC),
};
