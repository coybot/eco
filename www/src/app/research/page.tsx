...
const RESEARCH_DESCRIPTION =
  "Presidio publishes rigorous autonomy research on vision-language navigation for aerial and ground robots, modular architectures, swarm sensing, and large-scale datasets including Yonder.";

export const metadata: Metadata = {
  title: "Research",
  description: RESEARCH_DESCRIPTION,
  ...socialMeta("/research", "Research | Presidio", RESEARCH_DESCRIPTION),
};
        ...
        <section className="py-16 bg-gradient-to-b from-background to-card">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Papers, technical reports, and write-ups from the Presidio autonomy
            ...
            <div className="mb-10">
              ...
              <div className="relative w-full rounded-lg border border-border overflow-hidden" style={{ aspectRatio: "16/9" }}>
                <iframe
                  ...
                  title="Presidio L5 Autonomy Demo Reel"
