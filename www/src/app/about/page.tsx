...
const ABOUT_DESCRIPTION =
  "Presidio builds autonomy for uncrewed aircraft, rovers, and other robots: an open SDK, high-fidelity simulation, operator apps, and public datasets—plus custom vehicles when a mission needs purpose-built hardware.";

export const metadata: Metadata = {
  title: "About",
  description: ABOUT_DESCRIPTION,
  ...socialMeta("/about", "About | Presidio", ABOUT_DESCRIPTION),
};
...
export default function AboutPage() {
  const jsonLd = {
    ...
    isPartOf: { "@type": "WebSite", name: "Presidio", url: SITE.origin },
    mainEntity: {
      "@type": "Organization",
      name: "Presidio",
      url: SITE.origin,
      ...
      <main className="flex-1">
        <section className="py-16 bg-gradient-to-b from-background to-card">
          <div className="container mx-auto px-4 max-w-4xl">
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">About Presidio</h1>
            <p className="text-lg text-muted-foreground mb-8">
              Presidio builds the autonomy stack for uncrewed systems. We treat
        ...
        <section className="py-12 bg-card border-t border-border">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <p className="text-muted-foreground mb-6">
              ...
              understand Presidio is to use them.
            </p>
            <div className="flex flex-wrap gap-3">
              {proof.map((l) =>
                l.external ? (
