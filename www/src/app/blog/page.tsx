...
const BLOG_DESCRIPTION =
  "What we tried, what broke, and what we learned building and benchmarking an open-source drone autonomy stack.";

export const metadata: Metadata = {
  title: "Blog",
  description: BLOG_DESCRIPTION,
  ...socialMeta("/blog", "Blog | Presidio Autonomy", BLOG_DESCRIPTION),
};

const blogJsonLd = {
  "@context": "https://schema.org",
  "@type": "Blog",
  name: "Presidio Autonomy Blog",
  description: BLOG_DESCRIPTION,
              ...
              <Link key={post.slug} href={`/blog/${post.slug}`}>
                <Card className="h-full bg-card border-border hover:border-amber-500/50 transition-all group cursor-pointer">
                  <CardContent className="p-6">
                    ...
                    <h2 className="text-lg font-semibold mb-2 group-hover:text-amber-500 transition-colors">
                      {post.title}
                    </h2>
