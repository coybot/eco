...
const faqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "The metric gap is the disconnect between offline perception accuracy and closed-loop flight performance. In one Coybot study, fine-tuning a detector on 6.7 million frames improved detection mAP 9.7× (4.8% → 46.7%), yet closed-loop navigation success did not improve at all. Offline metrics measured the wrong thing; metric spatial grounding, not detection, was the binding constraint.",
  },
  {
    q: "Why does offline mAP mislead drone perception research?",
    a: "Offline detection metrics (like mAP) can rise sharply while real navigation does not, especially when the training and evaluation simulators disagree geometrically. Coybot built the Yonder dataset specifically to expose this cross-simulator generalization gap and to make closed-loop evaluation, not offline scores, the deciding metric.",
  },
  {
    q: "What is an autonomous drone SDK?",
    a: "An autonomous drone SDK is the software layer that lets developers build, test, and deploy autonomy — perception, planning, and control — on a drone. Coybot's SDK is open source and pairs with high-fidelity simulation (ArduPilot SITL for fast iteration, Isaac-class sim for full perception loops), so autonomy code is evaluated in closed loop before it reaches hardware. It runs on your own platform or on Coybot's NDAA-compliant Quadcopter, Rover, and Fixed-Wing.",
  },
  {
    q: "What sensing do large drone swarms need?",
    a: "Camera-only swarms degrade sharply at scale: in Coybot's simulations up to 1,000 agents, coverage dropped 15.8 percentage points and the collision rate rose 8× compared with ranging-equipped swarms. Ultra-wideband (UWB) ranging becomes effectively non-negotiable above roughly 100 drones.",
  },
  {
