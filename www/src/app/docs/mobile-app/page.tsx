...
const DESC = "Use the Coybot iOS or Android app to onboard, command, and monitor your autonomous drones from anywhere via the cloud.";

export const metadata: Metadata = {
  title: "Mobile Apps",
  description: DESC,
  ...socialMeta("/docs/mobile-app", "Mobile Apps | Coybot", DESC),
};
...
const steps = [
  {
    ...
    body: "Get Drone Operator from the App Store (iOS) or Google Play (Android). Sign in with your Coybot account.",
  },
  {
    n: "2",
        ...
        <section className="py-16 bg-gradient-to-b from-background to-card">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              Command any Coybot drone from your phone. The iOS and Android apps
