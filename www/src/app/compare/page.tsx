...
const DESC = "Compare the Presidio autonomous platforms side-by-side — Quadcopter, Rover, Fixed-Wing, and Phrover. Compute, sensors, runtime, payload, and use cases.";

export const metadata: Metadata = {
  title: "Compare Platforms",
  description: DESC,
  ...socialMeta("/compare", "Compare Platforms | Presidio", DESC),
};
