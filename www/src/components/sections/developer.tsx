...
const codeExample = `from coybot import CoybotClient

client = CoybotClient(api_key=os.environ["COYBOT_API_KEY"])
...
const resources = [
  ...
  },
  {
    icon: Github,
    title: "Open Source",
    description: "Contribute to coybot-sdk",
    href: "https://github.com/coybot/coybot-sdk",
  },
  {
    icon: Users,
    title: "Community",
    description: "Browse all repos on GitHub",
    href: "https://github.com/coybot",
  },
];
...
export function DeveloperSection() {
  ...
  const copyInstall = () => {
    navigator.clipboard.writeText("uv add coybot-sdk");
    setCopied(true);
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              ...
              proven, open source software. Sell your apps on the Coybot App Store 
